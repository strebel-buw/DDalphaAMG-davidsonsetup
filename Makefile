...
#-DSSE -msse4.2 
CFLAGS = -DPARAMOUTPUT -DTRACK_RES -DFGMRES_RESTEST 
# -DPROFILING
...
dd_alpha_amg : $(OBJ)
	$(CC) $(OPT_VERSION_FLAGS) $(LIMEH) -o $@ $(OBJ) $(H5LIB) $(LIMELIB) $(LAPACKLIB) -lm

dd_alpha_amg_db : $(OBJDB)
	$(CC) -g $(DEBUG_VERSION_FLAGS) $(LIMEH) -o $@ $(OBJDB) $(H5LIB) $(LIMELIB) $(LAPACKLIB) -lm
