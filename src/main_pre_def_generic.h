 ...
 */
  ...
  typedef struct {
    int iter, size, nconv, maxsize, setup_iter, initial_phase, on_D, arnoldi;
    PRECISION tol, time;
    complex_PRECISION *lambda, *theta, **H1, **H2, *s;
    vector_PRECISION Au, u, res, *X, *V, *AV, *W;
  } davidson_setup_PRECISION_struct;
