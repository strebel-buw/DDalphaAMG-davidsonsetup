...
//   if ( l->level == 0 ) {
//    vector_PRECISION ee=NULL;
//    MALLOC(ee, complex_PRECISION, 2*20*16);
//    vector_PRECISION_define( ee, 1, 0, 2*20*16, l );
//    apply_coarse_operator_PRECISION( p->w, ee, p->op, l, threading ); 
//    for( int i=0; i<5; i++) {
//      printf0("%lf+%lfi ", CSPLIT(p->w[i]));
//    }
//    FREE(ee, complex_PRECISION, 2*20*16);
// //    getchar();
//   }
